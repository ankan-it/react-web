                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="position-relative">
                                    ...
                                    <div className="custom-value">$1200 <span>Total</span>
                                    </div>
                                </div>
                                            ...
                                            <table className="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="text-end font-weight-medium"> 56.35% </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td className="text-end font-weight-medium"> 33.25% </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td className="text-end font-weight-medium"> 15.45% </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td className="text-end font-weight-medium"> 25.00% </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>Romania</td>
                                                        <td className="text-end"> 620 </td>
                                                        <td className="text-end font-weight-medium"> 10.25% </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td className="text-end font-weight-medium"> 75.00% </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
